...
def build_site():
    ...
    html_parts = [
        ...
        "<body>",
        "  <div id=\"root\">",
        "    <p style=\"padding:40px;text-align:center;color:#6B7280;font-family:sans-serif;\">",
        ...
        "      try {",
        "        root.innerHTML = \"<p style='padding:20px;text-align:center;'>Loading Stlite runtime...</p>\";",
        "        const stlite = await import(\"./stlite/stlite.js\");",
        "        root.innerHTML = \"<p style='padding:20px;text-align:center;'>Mounting Streamlit app...</p>\";",
        "        await stlite.mount({",
        ...
        "          \"<pre style='padding:20px;color:#666;white-space:pre-wrap;font-size:12px;'>\" +",
